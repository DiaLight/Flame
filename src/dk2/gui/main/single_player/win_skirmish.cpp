...
namespace {
    ...
    dk2::ButtonCfg Main_Scirmish_BtnArr[] {
        {
            ...
            188, 36, 2152, 184, 0, 0, 0, 0, 0, NULL, dk2::CButton_render_536700, 0x00000000, 15, 0x00000010, 0x00010000, 0
        },
        {
        ...
        },
        {
            ...
            64, 1044, 800, 116, 0, 0, 800, 116, 0, NULL, dk2::CButton_render_532670, 0x00000000, 270, 0x0000000A, 0x00090000, 32
        },
        {
            BT_CClickButton, 528, 0, dk2::Button_addAiPlayer, NULL, 0, 0, 0x00000000, 0x00000000, 0,
            64, 1180, 1360, 116, 0, 0, 1360, 116, 0, NULL, dk2::CButton_render_532670, 0x00000000, 1547, 0x0000000B, 0x00090001, 32
        },
        {
            BT_CClickButton, 454, 0, dk2::CButton_handleLeftClick_changeMenu, NULL, 34, 1, 0x00000022, 0x00000058, 0,
            1480, 1180, 960, 116, 1, 0, 960, 116, 0, NULL, dk2::CButton_render_532670, 0x00000000, 1495, 0x0000000C, 0x00090002, 32
        },
        {
            BT_CClickButton, 453, 0, dk2::CButton_handleLeftClick_5463B0, NULL, 0, 0, 0x00000000, 0x00000000, 0,
            1480, 1336, 960, 116, 0, 0, 960, 116, 0, NULL, dk2::CButton_render_532670, 0x00000000, 1496, 0x0000000D, 0x00090002, 32
        },
        {
            BT_CClickButton, 78, 0, dk2::CButton_handleLeftClick_changeMenu, NULL, 35, 1, 0x00000023, 0x00000057, 0,
            1480, 1484, 960, 116, 1, 0, 960, 116, 0, NULL, dk2::CButton_render_532670, 0x00000000, 2803, 0x0000000E, 0x00090002, 32
        },
        {
    ...
    dk2::WindowCfg Main_Scirmish_WinCfg {
        WID_Scirmish, 0, 0, 0, 0, 2560, 1920, 0, 0, 2560, 1920, 0, NULL, NULL, 0,
