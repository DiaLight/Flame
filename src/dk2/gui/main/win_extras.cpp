...
dk2::WindowCfg *Main_Extras_layout() {
    ...
    buttons.emplace_back() = {
        ...
        464, 40, 1600, 232, 0, 0, 0, 0, 0, NULL, dk2::CButton_render_536700, 0x00000000, 7, 0x00000000, 0x00000000, 0
    };
    buttons.emplace_back() = {
        BT_CClickButton, 19, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00120006, 0x003D0000, 0,
        616, 428, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 2802, 0x00000000, 0x00070002, 0
    };
    buttons.emplace_back() = {
        BT_CClickButton, 22, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00050006, 0x003B0001, 0,
        616, 576, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 93, 0x00000001, 0x00070002, 0
    };
    buttons.emplace_back() = {
        BT_CClickButton, 21, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00060006, 0x003E0002, 0,
        616, 888, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 86, 0x00000002, 0x00070002, 0
    };
    buttons.emplace_back() = {
        BT_CClickButton, 23, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00000006, 0x00630003, 0,
        616, 1040, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 372, 0x00000003, 0x00070002, 0
    };
    buttons.emplace_back() = {
    ...
    *window = {
        WID_Extras, 0, 0, 0, 0, 2560, 1920, 0, 0, 2560, 1920, 0, NULL, NULL, 0,
