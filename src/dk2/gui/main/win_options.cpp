...
dk2::WindowCfg *Main_Options_layout() {
    ...
    buttons.emplace_back() = {
        ...
        464, 24, 1600, 232, 0, 0, 0, 0, 0, NULL, dk2::CButton_render_536700, 0x00000000, 10, 0x00000000, 0x00000000, 0
    };
    buttons.emplace_back() = {
        BT_CClickButton, 110, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x000F0004, 0x001D0000, 0,
        608, 416, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 96, 0x00000000, 0x00060002, 33
    };
    buttons.emplace_back() = {
        BT_CClickButton, 111, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00100004, 0x001A0001, 0,
        608, 596, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 95, 0x00000001, 0x00060002, 33
    };
    buttons.emplace_back() = {
        BT_CClickButton, 112, 0, dk2::CButton_handleLeftClick_5394E0, NULL, 0, 0, 0x00110004, 0x003A0002, 0,
        608, 776, 1304, 172, 0, 0, 1304, 172, 0, NULL, dk2::CButton_render_532670, 0x00000000, 98, 0x00000002, 0x00060002, 33
    };
    buttons.emplace_back() = {
    ...
    *window = {
        WID_Options, 0, 0, 0, 0, 2560, 1920, 0, 0, 2560, 1920, 0, NULL, NULL, 0,
