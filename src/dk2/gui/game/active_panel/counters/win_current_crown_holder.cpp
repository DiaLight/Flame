...
dk2::WindowCfg *Counters_CurrentCrownHolder_layout() {
    ...
    buttons.emplace_back() = {
        ...
        0, 0, 444, 128, 0, 0, 444, 128, 1673, NULL, dk2::CButton_render_4274C0, 0x0000010C, 0, 0x00000000, 0x00000000, 0
    };
    ...
    *window = {
        GWID_Counters_CurrentCrownHolder, 0, 0, 464, 1320, 444, 128, 0, 0, 444, 128, 0, NULL, NULL, 0,
