...
dk2::WindowCfg *EscOptions_Load_layout() {
    ...
    buttons.emplace_back() = {
        ...
        20, 0, 2520, 72, 0, 0, 2520, 72, 0, NULL, dk2::CButton_render_428A30, 0x00000001, 143, 0x00000000, 0x00000000, 0
    };
    buttons.emplace_back() = {
        BT_CListBox, 3, 0, dk2::CButton_handleLeftClick_42A7D0, NULL, 0, 0, (uint32_t) dk2::CListBox_clickArg1_42A780, (uint32_t) dk2::CListBox_clickArg2_42A790, 0,
    ...
    *window = {
        GWID_EscOptions_Load, 0, 0, 0, 180, 2560, 1280, 0, 0, 2560, 1280, 0, NULL, NULL, 8,
