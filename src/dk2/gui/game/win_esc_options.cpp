...
dk2::WindowCfg *Game_EscOptions_layout() {
    ...
    buttons.emplace_back() = {  // Title "Options"
    ...
    buttons.emplace_back() = {  // Level Objective
    ...
    buttons.emplace_back() = {  // Game Options
    ...
    buttons.emplace_back() = {  // Restart Level
