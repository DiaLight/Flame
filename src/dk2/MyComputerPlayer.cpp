...
char dk2::MyComputerPlayer::tickRespondToAttack(char a2_tendancySpeed) {
    if (this->respondToAttack[(this->flags >> 14) & 0xF]._threatLevel >= 0) {
        ...
        while (true) {
            CPlayer *fE_cplayer = this->cplayer;
            if (fE_cplayer->totalNumberOfOwnedThings[0]) {
                            ...
                            if (f3C_health > (int) (v24_modHealth >> 2)) {
                                ...
                                if (v25 != 7 && v25 != 3) {
                                    ...
                                    if (f3C_health > (int) (v26_modHealth >> 1)
                                        ...
                                        && !this->cplayer->fun_4BCAE0(v20_creature->f0_tagId)
                ...
                --a2_tendancySpeed;
                if (!v20_creature) {
                    unsigned int v58_flags = ((((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14) | this->flags & 0xFFFC3FFF;
                    this->flags = v58_flags ^ (v58_flags ^
                                               ((((((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14) & 0xFFFC0000 |
                                                 this->flags & 0xFFFC0000)
                                                - 1)) & 0x3C0000;
                    return 0;
                }
                if (v20_creature->sub_48E6A0_dif(this->cplayer->f0_tagId)) {
                    int v27_doDrop = 0;
                    ...
                    int v28_respondIdx = (this->flags >> 14) & 0xF;
                    Vec3i v59_loc;
                    memset(&v59_loc, 0, sizeof(v59_loc));
                    unsigned __int16 v29_locX = this->respondToAttack[v28_respondIdx].x;
                    int v61_zero = 0;
                    unsigned __int16 v30_locY = this->respondToAttack[v28_respondIdx].y;
                    v59_loc.z = 0;
                    v59_loc.x = (v29_locX << 12) + 2048;
                    CWorld *fA_world = this->world;
                    v59_loc.y = (v30_locY << 12) + 2048;
                    if ((fA_world->v_getMapElem_2(&v59_loc)->f8 & 0xFFF) != this->cplayer->f0_tagId) {
                        unsigned int v71_locX = 0;
                        unsigned int v69_locY = 0;
                        int v32_respondIdx = (this->flags >> 14) & 0xF;
                        bool v74_whileBool = true;
                        unsigned int v33_locX = this->respondToAttack[v32_respondIdx].x;
                        unsigned __int16 v34_locY = this->respondToAttack[v32_respondIdx].y;
                        CWorld *v35_cworld = this->world;
                        ...
                        if (this->world->v_loc_509090(v33_locX, v73_locY)) {
                            CWorld *v42_cworld = this->world;
                            ...
                            if ((v42_cworld->cmap.pNavigationSystem->map.ptr_ui8[
                                ...
                                && (v43_mapElement->f8 & 0xFFF) == this->cplayer->f0_tagId) {
                                v71_locX = v33_locX;
                                v69_locY = v73_locY;
                                v74_whileBool = false;
                            }
                        ...
                        if (v74_whileBool) {
                            do {
                                if (f3C_health) {
                                    while (true) {
                                        if (this->world->v_loc_509090(v44_locX, v73_locY)) {
                                            CWorld *v48_cworld = this->world;
                                            ...
                                            if ((v48_cworld->cmap.pNavigationSystem->map.ptr_ui8[
                                                ...
                                                && (v49_mapElem->f8 & 0xFFF) == this->cplayer->f0_tagId) {
                                                break;
                                            }
                                        }
                                        v44_locX += v66_deltaY;
                                    ...
                                    while (true) {
                                        if (this->world->v_loc_509090(v44_locX, v73_locY)) {
                                            ...
                                            if ((v45_cworld->cmap.pNavigationSystem->map.ptr_ui8[
                                                ...
                                                && (v46_mapElem->f8 & 0xFFF) == this->cplayer->f0_tagId) {
                                                break;
                                            }
                                        }
                                        bool v47 = v70 == 1;
                        ...
                        if (v71_locX) {
                            this->respondToAttack[(this->flags >> 14) & 0xF].x = v71_locX;
                            this->respondToAttack[(this->flags >> 14) & 0xF].y = v69_locY;
                            int v50_respondIdx = (this->flags >> 14) & 0xF;
                            int v51_fl12Y = this->respondToAttack[v50_respondIdx].y << 12;
                            v59_loc.x = (this->respondToAttack[v50_respondIdx].x << 12) + 2048;
                    ...
                    if (v27_doDrop) {
                        this->cplayer->fun_4BFBD0(v20_creature);
                        this->cplayer->fun_4BC500(v20_creature->f0_tagId);
                        if (this->cplayer->fun_4BCAE0(v20_creature->f0_tagId)) {
                            v59_loc.x += 256;
                            CPlayer *v52_cplayer = this->cplayer;
                            v59_loc.y += 256;
                    ...
                    if (v53_level == 1)
                        ...
                        v55_threatLevel = v54_creatureData->_threatLevel
                                          * g_pObj6F2550->_threatLevelMultiplier[(unsigned __int8) v53_level]
                                          / 100;
                    this->respondToAttack[(this->flags >> 14) & 0xF]._threatLevel -= v55_threatLevel;
                }
                MyRespondToAttack *v56_respond = &this->respondToAttack[(this->flags >> 14) & 0xF];
            ...
            unsigned int v57_flags = (((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14;
            this->flags = (v57_flags | this->flags & 0xFFFC3FFF) ^ ((v57_flags | this->flags & 0xFFFC3FFF) ^
                                                                    ((v57_flags & 0xFFFC0000 |
                                                                      this->flags & 0xFFFC0000) - 1)) & 0x3C0000;
            return 0;
        }
    }
    if (a2_tendancySpeed) {
        while (true) {
            CPlayer *v3_cplayer = this->cplayer;
            if (!v3_cplayer->totalNumberOfOwnedThings[0])
                goto LABEL_23;
            CCreature *i_creature;
            for (i_creature = (CCreature *) sceneObjects[v3_cplayer->thingsOwnedList[0]];
                 i_creature;
                 i_creature = (CCreature *) sceneObjects[i_creature->fC_playerNodeY]) {
                int v5_respondIdx = (this->flags >> 14) & 0xF;
                int v6_locY = (this->respondToAttack[v5_respondIdx].y << 12) + 2048;
                int v65_cmapHeight = abs32(
                        i_creature->f16_pos.x
                        - ((this->respondToAttack[v5_respondIdx].x << 12)
                           + 2048));
                ...
                if (v68_value + f3C_health < 102400
                    ...
                    && (i_creature->lastDroppedCounter > 0x12Cu || this->world->getGameTick() <= 0x12C)
                    && !this->cplayer->fun_4BCAE0(i_creature->f0_tagId)
            ...
            --a2_tendancySpeed;
            if (i_creature) {
                if (i_creature->sub_48E6A0_dif(this->cplayer->f0_tagId)) {
                    this->cplayer->fun_4BFBD0(i_creature);
                    this->cplayer->fun_4BC500(i_creature->f0_tagId);
                    if (this->cplayer->fun_4BCAE0(i_creature->f0_tagId)) {
                        CPlayer *v7_cplayer = this->cplayer;
                        Vec3i v59_loc;
                        memset(&v59_loc, 0, sizeof(v59_loc));
                        Pos2us *dungeonHeartPosition = v7_cplayer->getDungeonHeartPosition();
                        Pos2us *v9_dungeonHeartPosition = this->cplayer->getDungeonHeartPosition();
                        int v10_posY = (dungeonHeartPosition->y << 12) + 2048;
                        v59_loc.x = (v9_dungeonHeartPosition->x << 12) + 2304;
                        v59_loc.y = v10_posY + 256;
                        CPlayer *v11_cplayer = this->cplayer;
                        v59_loc.z = 0;
                        uint16_t v74_direction = 0;
                    ...
                    if (v12_level == 1)
                        ...
                        v14_threatLevel = v13_creatureData->_threatLevel
                                          * g_pObj6F2550->_threatLevelMultiplier[(unsigned __int8) v12_level]
                                          / 100;
                    this->respondToAttack[(this->flags >> 14) & 0xF]._threatLevel += v14_threatLevel;
                }
                MyRespondToAttack *v15_respond = &this->respondToAttack[(this->flags >> 14) & 0xF];
                ...
                unsigned int v16_flags = (((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14;
                this->flags = (v16_flags | this->flags & 0xFFFC3FFF) ^ ((v16_flags | this->flags & 0xFFFC3FFF) ^
                                                                        ((v16_flags & 0xFFFC0000 |
                                                                          this->flags & 0xFFFC0000) - 1)) & 0x3C0000;
            } else {
                LABEL_23:
                unsigned int v17_flags = ((((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14) | this->flags & 0xFFFC3FFF;
                this->flags = v17_flags ^ (v17_flags ^
                                           ((((((((this->flags >> 14) & 0xFu) + 1) % 3) & 0xF) << 14) & 0xFFFC0000 |
                                             this->flags & 0xFFFC0000)
                                            - 1)) & 0x3C0000;
            }
